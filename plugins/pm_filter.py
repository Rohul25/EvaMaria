...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            await query.answer('Unblock the bot bro !', show_alert=True)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖 ɢʀᴏᴜᴘ', url='https://t.me/MoviesReqGroup')
        ], [
        ...
        if settings is not None:
            buttons = [
                ...
                [
                    InlineKeyboardButton('ʙᴏᴛ PM', callback_data=f'setgs#botpm#{settings["botpm"]}#{str(grp_id)}'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"If U didn't get any Movie , Tag @admin with your Movie Name./n Here is what i found for your query {search}"
